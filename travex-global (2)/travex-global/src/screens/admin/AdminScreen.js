...
const styles = StyleSheet.create({
  ...
  viewBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 42, borderRadius: radius.sm, borderWidth: 1.5, borderColor: colors.primary, gap: 6, backgroundColor: colors.white },
