...
const c = StyleSheet.create({
  ...
  pinCard: { backgroundColor: colors.white, borderRadius: 28, width: '100%', maxWidth: 380, padding: spacing.xl, alignItems: 'center' },
  ...
  qrCard: { backgroundColor: colors.white, borderRadius: 28, width: '100%', maxWidth: 380, padding: spacing.xl, alignItems: 'center' },
  ...
  chatCard: { width: '100%', maxWidth: 480, height: 480, backgroundColor: colors.white, borderRadius: 24, overflow: 'hidden' },
  ...
  chatInputRow: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: spacing.md, backgroundColor: colors.white, borderTopWidth: 1, borderTopColor: colors.border },
...
const cc = StyleSheet.create({
  card: { backgroundColor: colors.white, borderRadius: 20, borderWidth: 1, borderColor: colors.border, padding: spacing.lg, marginBottom: spacing.md, ...shadow.card },
  ...
  pinBox: { backgroundColor: colors.white, borderWidth: 1, borderColor: '#A7F3D0', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 8, alignItems: 'center' },
